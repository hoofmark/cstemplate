...
- **.NET 10 runtime** — required to run the `cstemplate` CLI tool
...
- [CLI reference](https://hoofmark.github.io/cstemplate/articles/cli.html)
- [API reference](https://hoofmark.github.io/cstemplate/api/HoofMark.CSharpTemplating.Abstractions.html)
